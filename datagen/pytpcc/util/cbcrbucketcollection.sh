...
curl http://$Url:9499/query/service -u $Auth -d 'statement=create scope default1.tpcc'

sleep 30
#create collections
echo curl http://$Url:8093/query/service -u $Auth -d 'statement=create collection default.tpcc.CUSTOMER'
curl http://$Url:9499/query/service -u $Auth -d 'statement=create collection default1.tpcc.CUSTOMER'
echo curl http://$Url:8093/query/service -u $Auth -d 'statement=create collection default.tpcc.DISTRICT'
curl http://$Url:9499/query/service -u $Auth -d 'statement=create collection default1.tpcc.DISTRICT'
