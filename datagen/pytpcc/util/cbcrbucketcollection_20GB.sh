...
Url=${1:-127.0.0.1}
Site=http://$Url:9000/pools/default/buckets/
...
curl http://$Url:9499/query/service -u $Auth -d 'statement=create scope default.tpcc'

sleep 30
#create collections
echo curl http://$Url:9499/query/service -u $Auth -d 'statement=create collection default.tpcc.customer'
curl http://$Url:9499/query/service -u $Auth -d 'statement=create collection default.tpcc.customer'
echo curl http://$Url:9499/query/service -u $Auth -d 'statement=create collection default.tpcc.district'
curl http://$Url:9499/query/service -u $Auth -d 'statement=create collection default.tpcc.district'
echo curl http://$Url:9499/query/service -u $Auth -d 'statement=create collection default.tpcc.history'
curl http://$Url:9499/query/service -u $Auth -d 'statement=create collection default.tpcc.history'
echo curl http://$Url:9499/query/service -u $Auth -d 'statement=create collection default.tpcc.item'
curl http://$Url:9499/query/service -u $Auth -d 'statement=create collection default.tpcc.item'
echo curl http://$Url:9499/query/service -u $Auth -d 'statement=create collection default.tpcc.neworder'
curl http://$Url:9499/query/service -u $Auth -d 'statement=create collection default.tpcc.neworder'
echo curl http://$Url:9499/query/service -u $Auth -d 'statement=create collection default.tpcc.orders'
curl http://$Url:9499/query/service -u $Auth -d 'statement=create collection default.tpcc.orders'
echo curl http://$Url:9499/query/service -u $Auth -d 'statement=create collection default.tpcc.stock'
curl http://$Url:9499/query/service -u $Auth -d 'statement=create collection default.tpcc.stock'
echo curl http://$Url:9499/query/service -u $Auth -d 'statement=create collection default.tpcc.warehouse'
curl http://$Url:9499/query/service -u $Auth -d 'statement=create collection default.tpcc.warehouse'
echo curl http://$Url:9499/query/service -u $Auth -d 'statement=create collection default.tpcc.supplier'
curl http://$Url:9499/query/service -u $Auth -d 'statement=create collection default.tpcc.supplier'
echo curl http://$Url:9499/query/service -u $Auth -d 'statement=create collection default.tpcc.nation'
curl http://$Url:9499/query/service -u $Auth -d 'statement=create collection default.tpcc.nation'
echo curl http://$Url:9499/query/service -u $Auth -d 'statement=create collection default.tpcc.region'
curl http://$Url:9499/query/service -u $Auth -d 'statement=create collection default.tpcc.region'
